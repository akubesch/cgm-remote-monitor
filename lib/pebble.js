...
// Playing to see if A1c can be added to Pebble summary 
  function addA1C() {
    //if (req.a1c) {
      ...
      var a1cResult = (Math.round(10*(ss.mean(mgDlBgs)+46.7)/28.7)/10).toFixed(1) + '%<sub>DCCT</sub>');
      if (a1cResult) {
        first.a1c = a1cResult.display || 0;
      }
    //}
  }    
